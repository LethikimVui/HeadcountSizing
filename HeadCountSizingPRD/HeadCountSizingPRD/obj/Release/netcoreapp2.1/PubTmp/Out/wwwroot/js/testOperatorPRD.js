...
$(document).ready(function () {
    ...
    function LoadTableData(_tranferWCId) {
        $.ajax({
            type: 'post',
            url: '/HCS/TestOperator/DataTable',
    ...
    function LoadEquipmentTable(_tranferWCId) {
        $.ajax({
            type: 'post',
            url: '/HCS/TestOperator/GetallStation',
            data: { wcId: _tranferWCId },
            success: function (response) {
    ...
    function LoadEquipemt(_tranferWCId, _stationOrTester) {
        ...
        $.ajax({
            type: 'post',
            url: '/HCS/TestOperator/GetEquipmentQuantity',
    ...
    function LoadDowntime(_tranferWCId) {
        $.ajax({
            type: 'post',
            url: '/HCS/TestOperator/GetAllDowntimeByWC',
            data: { wcId: _tranferWCId },
            success: function (response) {
                var data = response.result;
                $.each(data, function (index, value) {
    ...
    function AddStationData() {
        ...
        $.each(months, function (index, value) {
            ...
            $.ajax({
                type: 'post',
                url: '/HCS/TestOperator/AddStationData',
                dataType: 'json',
                data: JSON.stringify(model),
                contentType: "application/json; charset=utf-8",
            })
    ...
    function SaveStationQuantity(_tranferWCId, _monthId, _stationOrTester) {
        ...
        $.ajax({
            type: 'post',
            url: '/HCS/TestOperator/UpdateStationQuantity',
            dataType: 'json',
            data: JSON.stringify(model),
            contentType: "application/json; charset=utf-8",
            success: function (response) {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                $.each(data, function (index, value) {
                    ...
                    $.ajax({
                        type: 'post',
                        url: '/HCS/TestOperator/UpdateDowntime',
                        dataType: 'json',
                        data: JSON.stringify(model),
                        contentType: "application/json; charset=utf-8",
                        success: function (response) {
    ...
    function SaveHeadCount() {
        ...
        $.ajax({
            type: 'post',
            url: '/HCS/TestOperator/UpdateTestTech',
            dataType: 'json',
            data: JSON.stringify(model),
            contentType: "application/json; charset=utf-8",
            success: function (response) {
    ...
    function LoadResult(_tranferWCId) {
        $.ajax({
            type: 'post',
            url: '/HCS/TestOperator/GetFinalResult_partialview',
            data: { wcId: _tranferWCId },
            success: function (response) {
                debugger
