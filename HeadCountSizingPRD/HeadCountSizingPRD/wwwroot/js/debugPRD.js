$(document).ready(function () {
    ...
    function Load() {
        ...
        if (!_tranferWCId) {
            ...
            LoadDebugRawData(_tranferWCId)
            LoadDebugData(_tranferWCId)
            LoadDebugResult(_tranferWCId)
        }
    }

    function LoadDebugRawData(_tranferWCId) {
        debugger
        $.ajax({
            type: 'post',
            url: '/hcs/debug/GetRawDataAsync_partialview',
    ...
    function LoadDebugData(_tranferWCId) {
        $.ajax({
            type: 'post',
            url: '/hcs/debug/GetDebugData_partialview',
            data: { wcId: _tranferWCId },
            success: function (response) {
    ...
    function LoadDebugResult(_tranferWCId) {
        $.ajax({
            type: 'post',
