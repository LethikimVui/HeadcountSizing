...
namespace HeadCountSizingPRD.Controllers
{
    ...
    public class DebugController : Controller
    {
        ...
        public async Task<IActionResult> GetRawDataAsync_partialview([FromBody] AddRawDataViewModel model)
        {
            var rawdata = await debugService.GetRawData(model);
        ...
        public async Task<IActionResult> GetDebugData_partialview([FromBody] DebugDataViewModel model)
        {
            var token = User.GetSpecificClaim("token");
            var debugdata = await debugService.Debug_Data_getactive(model);
        ...
        public async Task<IActionResult> GetDebugResult_partialview([FromBody] DebugDataViewModel model)
        {
            var token = User.GetSpecificClaim("token");
            var debugresult = await debugService.Result_Debug_calculation(model);
